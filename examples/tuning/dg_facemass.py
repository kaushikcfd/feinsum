...
DB_FILENAME = "wave_facemass_3d_p3.db"
...
if __name__ == "__main__":
    ...
    if len(cl_ctx.devices) != 1:
        ...
        if 1:
            ...
            # t_unit = fnsm.generate_loopy_with_opt_einsum_schedule(expr)
            # print(t_unit)
            # print(lp.get_op_map(t_unit, subgroup_size=1).sum())
            # 1/0
